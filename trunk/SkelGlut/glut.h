...
/* All comments preceeded with MSH where entered by Scott Heiman.  These comments
   denote changes he made to force GLUT to work with the Borland compilers */
...
/* MSH
   The first line was "if 0".  I changed the 0 to a 1 because it was an "easy" fix.
*/
# if 1
...
/* MSH
  These are not necessary with Builder 4.0+.  The first 3 libraries are automatically
  linked with Builder applications.  You will need to manually add the glut32.lib
  file to your project.

  BC++ 5.02 will add winmm.lib automatically.  OpenGL32.lib, glu32.lib, and glut32.lib
...
/* MSH
  The following compiler directives are not needed when you include windows.h
*/
